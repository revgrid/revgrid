...
// Warning: (ae-internal-missing-underscore) The name "moveElementsInArray" should be prefixed with an underscore because the declaration is marked as @internal
//
// @internal (undocumented)
export function moveElementsInArray<T>(array: T[], fromIndex: number, toIndex: number, count: number): void;
