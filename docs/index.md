...
---------|-------------|---------
 0.4.1   | ?? Sep 2023 | Add recordMoved, recordReplaced & recordsReplaced to RevRecordStore.RecordsEventers<br>Improve RevRecordDataServer consistency checks<br>Fix move active column
