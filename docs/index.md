...
---------|-------------|---------
 0.3.1   | ?? Aug 2023 | Fix Paint AutoWidening<br>Add StandardTextPainter (contains behavior previously in StandardTextCellPainter)<br>Remove StandardTextCellPainter<br>Add StandardCheckboxPainter (contains behavior previously in StandardCheckboxCellPainter)
