import { RevAssertError, RevClientObject, RevDataServer, RevListChangedTypeId, RevPoint, RevSchemaField } from '../../common';
...
export class RevEventBehavior<BGS extends RevBehavioredGridSettings, BCS extends RevBehavioredColumnSettings, SF extends RevSchemaField> implements RevClientObject {
    ...
    constructor(
        ...
        /** @internal */
        private readonly _horizontalScroller: RevScroller,
        /** @internal */
        private readonly _verticalScroller: RevScroller,
        /** @internal */
