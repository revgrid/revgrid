...
export class ColumnSelection extends Feature {
    ...
    handleMouseDragCellSelection(grid: Hypegrid, x: number, keys: string[]) {
     ...
     * @param keys - array of the keys that are currently pressed down
     */
    extendSelection(grid: Hypegrid, x: number, keys: string[]) {
     ...
     */
    moveShiftSelect(grid: Hypegrid, offsetX: number) {
     ...
     * @param offsetX - x coordinate to start at
     */
    override moveSingleSelect(grid: Hypegrid, offsetX: number) {
        const extent = grid.getDragExtent();
    ...
    isColumnDragging(grid: Hypegrid) {
    ...
    private doubleClickDelay(grid: Hypegrid, event: CellEvent) {
    ...
    private doubleClickTimerCallback(grid: Hypegrid, event: CellEvent) {
        this.doubleClickTimer = undefined;
        this.dragging = true;
