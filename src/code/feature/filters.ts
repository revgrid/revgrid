...
export class Filters extends Feature {
    ...
    handleLEFT(grid: Hypegrid, cellEvent: CellEvent) {
        moveLaterally(grid, cellEvent, -1);
    }

    handleRIGHT(grid: Hypegrid, cellEvent: CellEvent) {
        moveLaterally(grid, cellEvent, +1);
    }
...
function moveLaterally(grid: Hypegrid, /*detail: Canvas.SyntheticEventDetail.Keyboard,*/ cellEvent: CellEvent, deltaX: number) {
...
function moveDown(grid: Hypegrid, /*detail: Canvas.SyntheticEventDetail.Keyboard,*/ cellEvent: CellEvent) {
    // const cellEvent = detail.editor.event; // previously detail was passed in
