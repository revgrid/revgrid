...
export class TouchScrolling extends Feature {
    ...
    override handleTouchStart(grid: Hypegrid, event: Canvas.TouchSyntheticEvent) {
    ...
    override handleTouchMove(grid: Hypegrid, event: Canvas.TouchSyntheticEvent) {
        ...
        grid.sbVScroller.scroll(yOffset);
    ...
    override handleTouchEnd(grid: Hypegrid, event: Canvas.TouchSyntheticEvent) {
        const currentTouch = this.getTouchedBounds(grid, event);
    ...
    getTouchedBounds(grid: Hypegrid, event: Canvas.TouchSyntheticEvent) {
    ...
    decelerateY(grid: Hypegrid, startTouch: CellInfo.Bounds, endTouch: CellInfo.Bounds) {
    ...
    decelerateX(grid: Hypegrid, startTouch: CellInfo.Bounds, endTouch: CellInfo.Bounds) {
