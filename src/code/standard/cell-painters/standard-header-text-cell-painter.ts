 ...
 * @public
 */
export class StandardHeaderTextCellPainter<BGS extends StandardBehavioredGridSettings, BCS extends StandardBehavioredColumnSettings> extends StandardTextCellPainter<BGS, BCS> {
    textWrapping = false;
