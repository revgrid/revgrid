...
import { GridSettingsMerge } from '../interfaces/settings/grid-settings-merge';
...
export abstract class MergableGridSettingsImplementation implements GridSettings, GridSettingsMerge {
    ...
    set columnAutosizingMax(value: number | undefined) { this._raw.columnAutosizingMax = value; }
    ...
    get eventDispatchEnabled() { return this._raw.eventDispatchEnabled; }
    set eventDispatchEnabled(value: boolean) { this._raw.eventDispatchEnabled = value; }
