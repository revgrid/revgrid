...
import { ColumnSettingsMerge } from '../interfaces/settings/column-settings-merge';
...
export abstract class MergableColumnSettingsImplementation implements ColumnSettingsMerge {
    ...
    set columnAutosizingMax(value: number | undefined) { this._columnAutosizingMax = value; }
    ...
    get width() { return this._width ?? this.gridSettings.defaultColumnWidth; }
