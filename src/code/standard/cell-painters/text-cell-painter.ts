...
/** @public */
export abstract class TextCellPainter<MGS extends StandardMergableGridSettings, MCS extends StandardMergableColumnSettings> extends StandardCellPainter<MGS, MCS> {
