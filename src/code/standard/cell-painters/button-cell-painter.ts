 ...
 * @public
 */
export class ButtonCellPainter<MGS extends StandardMergableGridSettings, MCS extends StandardMergableColumnSettings> extends StandardCellPainter<MGS, MCS> {
