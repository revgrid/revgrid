 ...
 * @public
 */
export class SparkLineCellPainter<MGS extends StandardMergableGridSettings, MCS extends StandardMergableColumnSettings> extends StandardCellPainter<MGS, MCS> {
