 ...
 * @public
 */
export class SliderCellPainter<MGS extends StandardMergableGridSettings, MCS extends StandardMergableColumnSettings> extends StandardCellPainter<MGS, MCS> {
