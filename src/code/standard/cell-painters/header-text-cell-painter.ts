 ...
 * @public
 */
export class HeaderTextCellPainter<MGS extends StandardMergableGridSettings, MCS extends StandardMergableColumnSettings> extends TextCellPainter<MGS, MCS> {
    textWrapping = false;
