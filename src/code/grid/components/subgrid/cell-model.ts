...
export interface CellModel {
     ...
     *
     * @param {ViewCell} cellEvent - All enumerable properties of this object will be copied to the new cell editor object for two purposes:
     ...
     */
//    getCellEditorAt?: (this: void, columnIndex: number, rowIndex: number, editorName: string, cellEvent: ViewCell) => CellEditor | undefined;
}
