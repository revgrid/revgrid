...
export const gridSettingChangeInvalidateTypeIds: GridSettingChangeInvalidateTypeIds = {
    ...
    mouseMultiCellRectangleSelectionDragActiveCursorName: GridSettingChangeInvalidateTypeId.None,
    mouseMultiCellRectangleSelectionDragActiveTitleText: GridSettingChangeInvalidateTypeId.None,
    mouseMultiCellRectangleSelectionEnabled: GridSettingChangeInvalidateTypeId.None,
    mouseMultiCellRectangleSelectionModifierKey: GridSettingChangeInvalidateTypeId.None,
