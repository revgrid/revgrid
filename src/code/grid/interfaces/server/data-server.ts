...
import { CellEditor } from '../serverless/cell-editor';
import { ServerlessViewCell } from '../serverless/serverless-view-cell';
...
export interface DataServer {
    ...
    getCellEditor?(cell: ServerlessViewCell): CellEditor | undefined;
}
