...
export class Column implements ColumnInterface {
     ...
     */
    /** @internal */
    constructor(private readonly _gridProperties: GridProperties, schemaColumn: SchemaModel.Column) {
        ...
        this._properties = new ColumnPropertiesAccessor(this._gridProperties, this); // see {@link Column#properties properties} setter
