...
export class FinBar {
    ...
    setViewport(start: number, finish: number) {
        this._viewportStart = start;
        this._viewportFinish = finish;
        this._viewportSize = finish - start + 1;
    ...
    scrollViewportStartTo(start: number) {
        this.index = start;
    }

    scroll(delta: number) {
        this.scrollViewportStartTo(this._viewportStart + delta);
    }
     ...
     */
    private _setScroll(viewportStart: number, barPosition?: number) {
    ...
    private setThumbSize() {
        ...
        if (this._viewportSize < this._contentSize) {
    ...
    onmousemove(evt: MouseEvent) {
        ...
        this._setScroll(viewportStart, barPosition);
