...
export class ColumnPropertiesAccessor implements ColumnProperties {
    ...
    private _halign: GridProperties.Halign | undefined;
    ...
    private _unsortable: boolean | undefined;
...
//
        ...
        set halign(value: GridProperties.Halign | undefined) { this._gridProperties.columnHeaderHalign = value; }
    ...
    export class Filter implements ColumnProperties.Filter {
        ...
        set halign(value: GridProperties.Halign | undefined) { this._gridProperties.filterHalign = value; }
        get format() { return this._gridProperties.columnHeaderFormat }
        set format(value: string | undefined) { this._gridProperties.columnHeaderFormat = value; }
