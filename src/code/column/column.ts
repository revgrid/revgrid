import { Behavior } from '../grid/behavior';
...
export class Column {
     ...
     */
    /** @internal */
    constructor(behavior: Behavior, schemaColumn: SchemaModel.Column, index: number) {
        if (index === undefined) {
            throw new AssertError('CC78331', 'Column index required.');
        }

        this.behavior = behavior;
        this.dataModel = behavior.mainDataModel;
        this.index = index;
        const name = schemaColumn.name;
        ...
        this._properties = new this.behavior.grid.columnPropertiesConstructor(behavior.grid.properties, this); // see {@link Column#properties properties} setter
        this.schemaColumn = schemaColumn;

        if (index < 0) {
            throw new AssertError('CC98322', 'New column index ' + index + ' out of range.');
        }
    }
