...
export interface Hooks {
    getCellPaintConfig?: (this: void, dataModel: DataModel, renderCell: RenderCell) => CellPaintConfig | undefined;
     ...
     */
    getCellPainter?: (this: void, dataModel: DataModel, cellPaintConfig: CellPaintConfig, gridPainterKey: string) => CellPainter | undefined;
     ...
     */
    getCellEditorAt?: (this: void, dataModel: DataModel, columnIndex: number, rowIndex: number, editorName: string, cellEvent: CellEvent) => CellEditor | undefined;
}
