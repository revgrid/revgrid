...
export class CellClickFeature extends Feature {
    ...
    override handleClick(grid: Hypergrid, event: CellEvent) {
        const consumed = (event.isDataCell || event.isTreeColumn) && (
     ...
     * @memberOf CellClick#
     */
    openLink(grid: Hypergrid, cellEvent: CellEvent): boolean | null | undefined | Window {
        ...
        let linkPropTuple: HypergridProperties.LinkProp | undefined;
        let link: boolean | string | HypergridProperties.LinkFunction;
