...
export class CanvasRenderingContext2DEx {
    private truncateTextWithEllipsis: true;
     ...
     * @param truncateTextWithEllipsis - _Per {@link module:defaults.truncateTextWithEllipsis}._
    ...
    getTextWidthTruncated(this: CanvasRenderingContext2DEx,
        text: string,
        width: number,
        truncateTextWithEllipsis: boolean | undefined,
        abort = false,
        truncateFromStart = true
    ): CanvasRenderingContext2DEx.TextWidthTruncated {
        let metrics = this.fontMetrics[this.cache.font];
        const truncating = truncateTextWithEllipsis !== undefined;
...
export namespace CanvasRenderingContext2DEx {
    ...
    export interface TextWidthTruncated {
