...
import { RangeSelectionModel } from '../dependencies/sparse-boolean-array';
import { Hypergrid } from '../grid/hypergrid';
import { InclusiveRectangle } from './inclusive-rectangle';
...
export class SelectionModel {
    ...
    lastSelectionType: SelectionModel.LastSelectionType[];
