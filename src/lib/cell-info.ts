...
export abstract class CellInfo {

    // getter caches
    private _columnProperties: ColumnProperties;
    private _cellOwnProperties: DataModel.CellOwnProperties | undefined;
    _bounds: CellInfo.Bounds;
     ...
     */
    constructor(public grid: Hypergrid, public gridX?: number, public gridY?: number) {
     ...
     * @returns Visibility.
     */
    resetGridXDataY(gridX: number, dataY: number, subgrid: Subgrid | null, useAllCells?: boolean) {
        ...
        if (useAllCells) {
            ...
            vr = {
                subgrid: subgrid ?? this.behavior.mainSubgrid,
                rowIndex: dataY,
                index: -1,
                top: -1,
                bottom: -1,
     ...
     */
    get value() { return this.subgrid.dataModel.getValue(this.dataCell.x, this.dataCell.y); }
    set value(value: unknown) { this.subgrid.dataModel.setValue(this.dataCell.x, this.dataCell.y, value); }
     ...
     */
    get dataRow() { return this.subgrid.getRow(this.dataCell.y); }

    /**
     * The bounds of the cell.
     */
    get bounds(): CellInfo.Bounds {
    ...
    set rowProperties(properties: DataModel.RowProperties) {
    ...
    get isRowHovered() {
        return this.grid.canvas.hasMouse && this.isDataRow && this.grid.hoverCell && this.grid.hoverGridCell.y === this.gridCell.y;
    }
