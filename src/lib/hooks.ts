...
export interface Hooks {
     ...
     */
    getCell?(dataModel: DataModel, config: CellPainter.Config, rendererName: string): CellPainter;
     ...
     */
    getCellEditorAt?(dataModel: DataModel, columnIndex: number, rowIndex: number, editorName: string, cellEvent: CellEvent): CellEditor;
}
