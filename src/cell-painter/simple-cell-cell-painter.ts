...
export class SimpleCellPainter extends CellPainter {
    override paint(gc: CanvasRenderingContext2DEx, config: CellPainter.Config) {
        ...
        let hover: HypergridProperties.HoverColors;
 ...
 */
function renderMultiLineText(gc: CanvasRenderingContext2DEx, config: CellPainter.Config, val: string, leftPadding: number, rightPadding: number) {
 ...
 * @param val - The text to render in the cell.
 */
function renderSingleLineText(gc: CanvasRenderingContext2DEx, config: CellPainter.Config, val: string, leftPadding: number, rightPadding: number) {
    ...
    const halign = config.halign;
    let minWidth: number;
    let metrics: CanvasRenderingContext2DEx.TextWidthTruncated;
...
function findLines(gc: CanvasRenderingContext2DEx, config: CellPainter.Config, words: string[], width: number) {
...
function strikeThrough(config: CellPainter.Config, gc: CanvasRenderingContext2DEx, text: string, x: number, y: number, thickness: number) {
...
function underline(config: CellPainter.Config, gc: CanvasRenderingContext2DEx, text: string, x: number, y: number, thickness: number) {
    const textHeight = gc.getTextHeight(config.font).height;
    const textWidth = gc.getTextWidth(text);
