...
import { RenderCellPropertiesAccessor } from './render-cell-properties-accessor';
...
export abstract class CellPainter {
     ...
     * @this {CellEditor}
     *
     * @param {Canvas.CanvasRenderingContext2DEx} gc
     *
     * @param {CellPainter["renderConfig"]} config
     *
     ...
     */
    abstract paint(gc: CanvasRenderingContext2DEx, config: CellPainter.Config): void;
...
export namespace CellPainter {
    ...
    export type Config = RenderCellProperties;

    export type ConfigAccessor = RenderCellPropertiesAccessor;
}
