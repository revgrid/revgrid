...
/** @public */
export class InMemoryAppBehavioredGridSettings extends RevSimpleInMemoryBehavioredGridSettings implements AppBehavioredGridSettings {
    private _focusedRowBorderWidth: number;
    private _grayedOutForegroundColor: RevGridSettings.Color;
    private _focusedRowBackgroundColor: RevGridSettings.Color | undefined;
    private _focusedRowBorderColor: RevGridSettings.Color | undefined;
    private _focusedCellBorderColor: RevGridSettings.Color;
    private _valueRecentlyModifiedBorderColor: RevGridSettings.Color;
    private _valueRecentlyModifiedUpBorderColor: RevGridSettings.Color;
    private _valueRecentlyModifiedDownBorderColor: RevGridSettings.Color;
    private _recordRecentlyUpdatedBorderColor: RevGridSettings.Color;
    private _recordRecentlyInsertedBorderColor: RevGridSettings.Color;
    ...
    set grayedOutForegroundColor(value: RevGridSettings.Color) {
    ...
    set focusedRowBackgroundColor(value: RevGridSettings.Color | undefined) {
    ...
    set focusedRowBorderColor(value: RevGridSettings.Color | undefined) {
    ...
    set focusedCellBorderColor(value: RevGridSettings.Color) {
    ...
    set valueRecentlyModifiedBorderColor(value: RevGridSettings.Color) {
    ...
    set valueRecentlyModifiedUpBorderColor(value: RevGridSettings.Color) {
    ...
    set valueRecentlyModifiedDownBorderColor(value: RevGridSettings.Color) {
    ...
    set recordRecentlyUpdatedBorderColor(value: RevGridSettings.Color) {
    ...
    set recordRecentlyInsertedBorderColor(value: RevGridSettings.Color) {
