...
export class Controls {
    ...
    private handleUiInsertRecordAction(mouseEvent: MouseEvent) {
        ...
        if (mouseEvent.shiftKey || isNaN(recordIndex) || recordIndex > this._recordStore.recordCount) {
    ...
    private handleColumnsWidthChanged(_columns: RevColumn<RevSimpleBehavioredColumnSettings, GridField>[]): void {
        this._activeWidthSpanElement.textContent = this._grid.calculateActiveColumnsWidth().toString();
    }
