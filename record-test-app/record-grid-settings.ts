...
export interface RecordGridSettings {
    ...
    colorMap: RecordGridSettings.ColorMap;
}

/** @public */
export namespace RecordGridSettings {
    export function assignPropertiesTo<T=RecordGridSettings>(source: Partial<T>, target: T): void {
        type Key = keyof T;
